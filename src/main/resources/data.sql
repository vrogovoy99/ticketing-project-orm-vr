...
insert into projects(project_name, project_code, project_detail, project_status, start_date, end_date, assigned_manager_id, complete_task_counts, unfinished_task_counts )
select 'Project One', 'P01', 'First Project', 'OPEN', '2004-01-06', '2024-05-12', id, 0, 0 from users where first_name='Suzan';

insert into projects(project_name, project_code, project_detail, project_status, start_date, end_date, assigned_manager_id, complete_task_counts, unfinished_task_counts )
select 'Project Two', 'P02', 'Second Project', 'OPEN', '2007-05-08', '2024-05-12', id, 0, 0 from users where first_name='Suzan';